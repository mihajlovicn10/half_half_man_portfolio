const translation = {
  ...
  techStack: {
    ...
    subtitle: "Technologies behind our development process",
    ...
    categories: {
      backend: {
        ...
        description: "Technologies used for the server side of applications."
      },
      frontend: {
        title: "Frontend Development",
        description: "Technologies used for the user-facing side of applications."
      },
      security: {
        title: "Cybersecurity",
        description: "Tools and practices for securing digital systems."
      },
      maintenance: {
        title: "Maintenance & Optimization",
        description: "Tools used to maintain and improve performance and uptime."
      }
    },
    tools: {
      python: {
  ...
  projects: {
    ...
    meta: {
      ...
      description: 'Explore selected software projects and case studies.'
    },
    detail: {
    ...
    items: {
      ecommerce: {
        ...
        description: 'A full-featured web store with login, admin, payments, and more.',
        summary: 'A modern e-commerce app built with Django, React, and PostgreSQL.',
        thumbnail: {
          alt: 'E-commerce homepage thumbnail'
        },
        features: [
          'User authentication and profile management',
          'Product management with categories and tags',
          'Cart and order system with checkout flow',
          'Admin dashboard with analytics',
          'Responsive UI and dark mode support'
        ],
        challenges: [
          'Synchronizing cart logic between frontend and backend',
          'Handling complex user permissions',
          'Designing flexible database schema'
        ],
        solutions: [
          'Used Redux for state management and Django REST for API',
          'Applied RBAC pattern with Django groups',
          'Normalized DB design with reusable models'
        ]
      },
      portfolio: {
        title: 'Personal Portfolio Website',
        summary: 'Modern and responsive portfolio website built with React and Next.js.',
        thumbnail: {
      ...
      security: {
        ...
        summary: 'Automated security testing and vulnerability assessment platform.',
        thumbnail: {
