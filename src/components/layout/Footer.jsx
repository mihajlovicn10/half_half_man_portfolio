...
const Footer = () => {
  ...
  const footerLinks = {
    ...
    social: [
      { name: 'Facebook', url: 'https://www.facebook.com/profile.php?id=61591582768040', icon: 'facebook' },
      { name: 'Instagram', url: 'https://www.instagram.com/half_half_man/', icon: 'instagram' },
      { name: 'LinkedIn', url: 'https://www.linkedin.com/company/half-half-man/about/?viewAsMember=true', icon: 'linkedin' },
